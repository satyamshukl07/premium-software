...
/* ========================================================================= */
/* 2. USER / CUSTOMER AUTHENTICATION                                         */
/* ========================================================================= */

router.post('/user/signup', loginLimiter, userSignup);
router.post('/user/register', loginLimiter, userSignup);
router.post('/user/login', loginLimiter, userLogin);
router.get('/user/me', authenticateUser, getUserMe);
