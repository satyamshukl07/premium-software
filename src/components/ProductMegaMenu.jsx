  ...
  const products = [
    {
      id: 'mex',
      name: 'MEX CMMS',
      tagline: 'Maintenance Management Software',
      ...
      description:
        'Australia’s #1 computerized maintenance management system for asset lifecycles, mobile work orders, inventory control, and AI preventive maintenance scheduling.',
      quickLinks: [
        { name: 'MEX Overview', path: '/product/mex-overview', icon: Layers },
        { name: 'MEX Apps', path: '/product/mex-apps', icon: Smartphone },
        { name: 'Services & Support', path: '/product/services', icon: Shield },
        { name: 'Integrations', path: '/product/integrations', icon: Activity },
        { name: 'Inventory Management', path: '/product/inventory-management', icon: Package },
        { name: 'Prestart Checklist', path: '/product/prestart-checklist', icon: ClipboardCheck },
        { name: 'Work Request Management', path: '/product/work-request-management', icon: FileText },
        { name: 'Multi-Site Management', path: '/product/multi-site-management', icon: Building2 },
        { name: 'Admin Control Centre', path: '/product/admin-control-centre', icon: Sliders },
        { name: 'AI Insights & Reporting', path: '/product/ai-insights-reporting', icon: LineChart },
        { name: 'Inspections Automation', path: '/product/inspections', icon: CheckCircle2 },
        { name: 'AI Maintenance Scheduling', path: '/product/ai-maintenance-scheduling', icon: CalendarClock },
      ],
      highlights: ['Used by 12,000+ facilities', 'Over 30 years in Australia', 'Zero-downtime asset tracking'],
    },
    {
      id: 'chm',
      name: 'CHM',
