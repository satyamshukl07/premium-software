  ...
  const sitemapSections = [
    {
      ...
      links: [
        { label: 'Techtonika Autolink — Overview', url: '/products/techtonika-autolink' },
        { label: 'Techtonika Autolink — Features', url: '/products/techtonika-autolink#features' },
        { label: 'Techtonika Autolink — Pricing', url: '/pricing' },
        { label: 'Techtonika Autolink — User Portal', url: '/user-portal' },
    ...
    },
    {
      ...
      links: [
        { label: 'Asset Management (Techtonika Autolink)', url: '/solutions/asset-management' },
        { label: 'Preventive Maintenance (Techtonika Autolink)', url: '/solutions/preventive-maintenance' },
