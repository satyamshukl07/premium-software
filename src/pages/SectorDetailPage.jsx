...
const sectorDataMap = {
  ...
  'construction-mining': {
    ...
    type: 'Industry Solution',
    description: 'Manage heavy earthmoving machinery, drill rigs, haul trucks, and support light vehicles with offline mobile apps, telematics, and extreme duty cycles.',
  ...
  'logistics-transport': {
    ...
    type: 'Industry Solution',
    description: 'Simplify fleet maintenance to improve uptime, driver safety, NHVR compliance, and transport logistics reliability nationwide.',
    image: 'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&fit=crop&w=1200&q=80',
    stat1: '99.1%',
    stat1Label: 'On-Time Fleet Dispatch',
    stat2: 'NHVR',
  ...
  'rental-mobility': {
    ...
    type: 'Industry Solution',
    description: 'Streamline vehicle turnaround, workshop servicing, automated bond holds, and direct marketplace reservations for independent rental operators.',
